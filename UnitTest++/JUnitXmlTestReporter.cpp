#include "JUnitXmlTestReporter.h"
#include <cstdio>
...
namespace UnitTest {
   ...
   void JUnitXmlTestReporter::ReportFailure(TestDetails const& details, char const* failure)
   {
      using namespace std;
   ...
   void JUnitXmlTestReporter::ReportTestStart(TestDetails const& /*test*/)
   {}

   void JUnitXmlTestReporter::ReportTestFinish(TestDetails const& /*test*/, float)
   {}

   void JUnitXmlTestReporter::ReportSummary(int const totalTestCount, int const failedTestCount,
